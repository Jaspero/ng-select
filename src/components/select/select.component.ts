...
@Component({
    ...
    filterHandler() {
        if (this.search === '') {
            ...
            if (this.matchFromStart) {
                this.filteredSelection = this.formatedSelection.filter(value => value[this.key].indexOf(this.search) === 0);
            } else {
                this.filteredSelection = this.formatedSelection.filter(value => value[this.key].indexOf(this.search) !== -1)
            }
        }
    }
